...
public class Bloque20 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bloque20);
    ...
    public void ejecutar_info(View vista) {
        ...
        Intent i = new Intent(Bloque20.this, InfoClase.class);
        startActivity(i);
    }
    ...
    public void ejecutar_mapa(View vista){
        ...
        Intent inten = new Intent(Bloque20.this, Bloque20Maps.class);
        startActivity(inten);
    }
