...
public class Bloque34 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bloque34);
    ...
    public void ejecutar_info(View vista) {
        ...
        Intent i = new Intent(Bloque34.this, InfoClase.class);
        startActivity(i);
    }

    public void ejecutar_mapa(View vista){
        Intent inten = new Intent(Bloque34.this, Bloque34Maps.class);
        startActivity(inten);
    }
