...
public class Bloque12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bloque12);
    ...
    public void ejecutar_info(View vista) {
        ...
        Intent i = new Intent(Bloque12.this, InfoClase.class);
        startActivity(i);
    }
    ...
    public void ejecutar_mapa(View vista){
        ...
        Intent inten = new Intent(Bloque12.this, Bloque12Maps.class);
        startActivity(inten);
    }
