...
public class Bloque8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bloque8);
    ...
    public void ejecutar_info(View vista) {
        ...
        Intent i = new Intent(Bloque8.this, InfoClase.class);
        startActivity(i);
    }
    ...
    public void ejecutar_mapa(View vista){
        ...
        Intent inten = new Intent(Bloque8.this, Bloque8Maps.class);
        startActivity(inten);
    }
