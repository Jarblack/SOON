...
public class Bloque7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bloque7);
    ...
    public void ejecutar_info(View vista) {
        ...
        Intent i = new Intent(Bloque7.this, InfoClase.class);
        startActivity(i);
    }
    ...
    public void ejecutar_mapa(View vista){
        ...
        Intent inten = new Intent(Bloque7.this, Bloque7Maps.class);
        startActivity(inten);
    }
