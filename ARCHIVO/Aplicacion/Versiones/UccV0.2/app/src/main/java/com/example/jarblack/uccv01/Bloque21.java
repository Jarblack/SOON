...
public class Bloque21 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bloque21);
    ...
    public void ejecutar_info(View vista) {
        ...
        Intent i = new Intent(Bloque21.this, InfoClase.class);
        startActivity(i);
    }
    ...
    public void ejecutar_mapa(View vista){
        ...
        Intent inten = new Intent(Bloque21.this, Bloque21Maps.class);
        startActivity(inten);
    }
