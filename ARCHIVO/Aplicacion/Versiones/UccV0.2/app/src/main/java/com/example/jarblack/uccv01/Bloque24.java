...
public class Bloque24 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bloque24);
    ...
    public void ejecutar_info(View vista) {
        ...
        Intent i = new Intent(Bloque24.this, InfoClase.class);
        startActivity(i);
    }
    ...
    public void ejecutar_mapa(View vista){
        ...
        Intent inten = new Intent(Bloque24.this, Bloque24Maps.class);
        startActivity(inten);
    }
