...
public class Bloque22 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bloque22);
    ...
    public void ejecutar_info(View vista) {
        ...
        Intent i = new Intent(Bloque22.this, InfoClase.class);
        startActivity(i);
    }
    ...
    public void ejecutar_mapa(View vista){
        ...
        Intent inten = new Intent(Bloque22.this, Bloque22Maps.class);
        startActivity(inten);
    }
