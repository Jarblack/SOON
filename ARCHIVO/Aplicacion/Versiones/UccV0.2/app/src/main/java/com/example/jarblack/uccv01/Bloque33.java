...
/**
 * Created by Jarblack on 10/11/2017.
 */

public class Bloque33 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bloque33);
    ...
    public void ejecutar_info(View vista) {
        ...
        Intent i = new Intent(Bloque33.this, InfoClase.class);
        startActivity(i);
    }

    public void ejecutar_mapa(View vista){
        Intent inten = new Intent(Bloque33.this, Bloque33Maps.class);
        startActivity(inten);
    }
