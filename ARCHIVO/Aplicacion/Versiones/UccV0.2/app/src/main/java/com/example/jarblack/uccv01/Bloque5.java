...
public class Bloque5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bloque5);
    ...
    public void ejecutar_info(View vista) {
        ...
        Intent i = new Intent(Bloque5.this, InfoClase.class);
        startActivity(i);
    }
    ...
    public void ejecutar_mapa(View vista){
        ...
        Intent inten = new Intent(Bloque5.this, Bloque5Maps.class);
        startActivity(inten);
    }
