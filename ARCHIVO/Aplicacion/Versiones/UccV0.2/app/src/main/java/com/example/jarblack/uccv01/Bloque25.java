...
public class Bloque25 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bloque25);
    ...
    public void ejecutar_info(View vista) {
        ...
        Intent i = new Intent(Bloque25.this, InfoClase.class);
        startActivity(i);
    }
    ...
    public void ejecutar_mapa(View vista){
        ...
        Intent inten = new Intent(Bloque25.this, Bloque25Maps.class);
        startActivity(inten);
    }
