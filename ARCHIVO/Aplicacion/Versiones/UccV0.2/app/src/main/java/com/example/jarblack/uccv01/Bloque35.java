...
public class Bloque35 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bloque35);
    ...
    public void ejecutar_info(View vista) {
        ...
        Intent i = new Intent(Bloque35.this, InfoClase.class);
        startActivity(i);
    }

    public void ejecutar_mapa(View vista){
        Intent inten = new Intent(Bloque35.this, Bloque35Maps.class);
        startActivity(inten);
    }
