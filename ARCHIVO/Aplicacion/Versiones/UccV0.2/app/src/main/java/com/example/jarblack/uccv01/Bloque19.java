...
public class Bloque19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bloque19);
    ...
    public void ejecutar_info(View vista) {
        ...
        Intent i = new Intent(Bloque19.this, InfoClase.class);
        startActivity(i);
    }
    ...
    public void ejecutar_mapa(View vista){
        ...
        Intent inten = new Intent(Bloque19.this, Bloque19Maps.class);
        startActivity(inten);
    }
