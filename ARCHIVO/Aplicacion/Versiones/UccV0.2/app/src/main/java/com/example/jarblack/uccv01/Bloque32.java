...
public class Bloque32 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bloque32);
    ...
    public void ejecutar_info(View vista) {
        ...
        Intent i = new Intent(Bloque32.this, InfoClase.class);
        startActivity(i);
    }

    public void ejecutar_mapa(View vista){
        Intent inten = new Intent(Bloque32.this, Bloque32Maps.class);
        startActivity(inten);
    }
