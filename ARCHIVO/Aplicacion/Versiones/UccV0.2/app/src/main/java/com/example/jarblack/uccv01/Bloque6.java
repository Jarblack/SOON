...
public class Bloque6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bloque6);
    ...
    public void ejecutar_info(View vista) {
        ...
        Intent i = new Intent(Bloque6.this, InfoClase.class);
        startActivity(i);
    }
    ...
    public void ejecutar_mapa(View vista){
        ...
        Intent inten = new Intent(Bloque6.this, Bloque6Maps.class);
        startActivity(inten);
    }
