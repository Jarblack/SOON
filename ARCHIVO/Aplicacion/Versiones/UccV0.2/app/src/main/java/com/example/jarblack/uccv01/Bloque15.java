...
public class Bloque15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bloque15);
    ...
    public void ejecutar_info(View vista) {
        ...
        Intent i = new Intent(Bloque15.this, InfoClase.class);
        startActivity(i);
    }
    ...
    public void ejecutar_mapa(View vista){
        ...
        Intent inten = new Intent(Bloque15.this, Bloque15Maps.class);
        startActivity(inten);
    }
