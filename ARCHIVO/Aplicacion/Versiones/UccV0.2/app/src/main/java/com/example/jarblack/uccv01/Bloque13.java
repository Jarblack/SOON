...
public class Bloque13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bloque13);
    ...
    public void ejecutar_info(View vista) {
        ...
        Intent i = new Intent(Bloque13.this, InfoClase.class);
        startActivity(i);
    }
    ...
    public void ejecutar_mapa(View vista){
        ...
        Intent inten = new Intent(Bloque13.this, Bloque13Maps.class);
        startActivity(inten);
    }
