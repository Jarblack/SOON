...
public class Bloque3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bloque3);
    ...
    public void ejecutar_info(View vista) {
        ...
        Intent i = new Intent(Bloque3.this, InfoClase.class);
        startActivity(i);
    }
    ...
    public void ejecutar_mapa(View vista){
        ...
        Intent inten = new Intent(Bloque3.this, Bloque3Maps.class);
        startActivity(inten);
    }
