...
public class Lista extends AppCompatActivity{
    ...
    public void ejecutar_bloque32(View vista){

        Intent i=new Intent(Lista.this, Bloque32.class);
        startActivity(i);
    }

    public void ejecutar_bloque33(View vista){

        Intent i=new Intent(Lista.this, Bloque33.class);
        startActivity(i);
    }

    public void ejecutar_bloque34(View vista){

        Intent i=new Intent(Lista.this, Bloque34.class);
        startActivity(i);
    }

    public void ejecutar_bloque35(View vista){

        Intent i=new Intent(Lista.this, Bloque35.class);
        startActivity(i);
    }
