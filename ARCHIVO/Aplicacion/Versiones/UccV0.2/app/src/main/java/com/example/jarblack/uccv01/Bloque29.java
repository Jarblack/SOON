...
public class Bloque29 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bloque29);
    ...
    public void ejecutar_info(View vista) {
        ...
        Intent i = new Intent(Bloque29.this, InfoClase.class);
        startActivity(i);
    }
    ...
    public void ejecutar_mapa(View vista){
        ...
        Intent inten = new Intent(Bloque29.this, Bloque29Maps.class);
        startActivity(inten);
    }
