...
public class Bloque23 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bloque23);
    ...
    public void ejecutar_info(View vista) {
        ...
        Intent i = new Intent(Bloque23.this, InfoClase.class);
        startActivity(i);
    }
    ...
    public void ejecutar_mapa(View vista){
        ...
        Intent inten = new Intent(Bloque23.this, Bloque23Maps.class);
        startActivity(inten);
    }
