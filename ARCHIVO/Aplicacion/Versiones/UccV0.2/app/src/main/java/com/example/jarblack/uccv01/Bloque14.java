...
public class Bloque14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bloque14);
    ...
    public void ejecutar_info(View vista) {
        ...
        Intent i = new Intent(Bloque14.this, InfoClase.class);
        startActivity(i);
    }
    ...
    public void ejecutar_mapa(View vista){
        ...
        Intent inten = new Intent(Bloque14.this, Bloque14Maps.class);
        startActivity(inten);
    }
