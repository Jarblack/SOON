...
public class Bloque30 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bloque30);
    ...
    public void ejecutar_info(View vista) {
        ...
        Intent i = new Intent(Bloque30.this, InfoClase.class);
        startActivity(i);
    }
    ...
    public void ejecutar_mapa(View vista){
        ...
        Intent inten = new Intent(Bloque30.this, Bloque30Maps.class);
        startActivity(inten);
    }
