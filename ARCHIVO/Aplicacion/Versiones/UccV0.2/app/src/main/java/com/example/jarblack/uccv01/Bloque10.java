...
public class Bloque10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bloque10);
    ...
    public void ejecutar_info(View vista) {
        ...
        Intent i = new Intent(Bloque10.this, InfoClase.class);
        startActivity(i);
    }
    ...
    public void ejecutar_mapa(View vista){
        ...
        Intent inten = new Intent(Bloque10.this, Bloque10Maps.class);
        startActivity(inten);
    }
