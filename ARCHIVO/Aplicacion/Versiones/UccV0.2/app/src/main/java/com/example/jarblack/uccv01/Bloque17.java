...
public class Bloque17 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bloque17);
    ...
    public void ejecutar_info(View vista) {
        ...
        Intent i = new Intent(Bloque17.this, InfoClase.class);
        startActivity(i);
    }
    ...
    public void ejecutar_mapa(View vista){
        ...
        Intent inten = new Intent(Bloque17.this, Bloque17Maps.class);
        startActivity(inten);
    }
