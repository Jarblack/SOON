...
public class Bloque18 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bloque18);
    ...
    public void ejecutar_info(View vista) {
        ...
        Intent i = new Intent(Bloque18.this, InfoClase.class);
        startActivity(i);
    }
    ...
    public void ejecutar_mapa(View vista){
        ...
        Intent inten = new Intent(Bloque18.this, Bloque18Maps.class);
        startActivity(inten);
    }
