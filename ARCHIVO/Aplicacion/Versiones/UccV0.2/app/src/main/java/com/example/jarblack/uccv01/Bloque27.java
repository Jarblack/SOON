...
public class Bloque27 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bloque27);
    ...
    public void ejecutar_info(View vista) {
        ...
        Intent i = new Intent(Bloque27.this, InfoClase.class);
        startActivity(i);
    }
    ...
    public void ejecutar_mapa(View vista){
        ...
        Intent inten = new Intent(Bloque27.this, Bloque27Maps.class);
        startActivity(inten);
    }
