...
public class Bloque16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bloque16);
    ...
    public void ejecutar_info(View vista) {
        ...
        Intent i = new Intent(Bloque16.this, InfoClase.class);
        startActivity(i);
    }
    ...
    public void ejecutar_mapa(View vista){
        ...
        Intent inten = new Intent(Bloque16.this, Bloque16Maps.class);
        startActivity(inten);
    }
