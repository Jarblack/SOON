...
public class Bloque9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bloque9);
    ...
    public void ejecutar_info(View vista) {
        ...
        Intent i = new Intent(Bloque9.this, InfoClase.class);
        startActivity(i);
    }
    ...
    public void ejecutar_mapa(View vista){
        ...
        Intent inten = new Intent(Bloque9.this, Bloque9Maps.class);
        startActivity(inten);
    }
