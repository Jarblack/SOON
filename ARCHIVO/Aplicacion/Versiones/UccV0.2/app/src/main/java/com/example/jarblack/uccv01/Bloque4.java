...
public class Bloque4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bloque4);
    ...
    public void ejecutar_info(View vista) {
        ...
        Intent i = new Intent(Bloque4.this, InfoClase.class);
        startActivity(i);
    }
    ...
    public void ejecutar_mapa(View vista){
        ...
        Intent inten = new Intent(Bloque4.this, Bloque4Maps.class);
        startActivity(inten);
    }
