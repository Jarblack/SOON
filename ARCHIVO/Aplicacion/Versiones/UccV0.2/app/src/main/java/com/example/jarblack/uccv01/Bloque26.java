...
public class Bloque26 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bloque26);
    ...
    public void ejecutar_info(View vista) {
        ...
        Intent i = new Intent(Bloque26.this, InfoClase.class);
        startActivity(i);
    }
    ...
    public void ejecutar_mapa(View vista){
        ...
        Intent inten = new Intent(Bloque26.this, Bloque26Maps.class);
        startActivity(inten);
    }
