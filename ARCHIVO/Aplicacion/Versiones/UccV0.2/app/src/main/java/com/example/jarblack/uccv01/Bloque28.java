...
public class Bloque28 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bloque28);
    ...
    public void ejecutar_info(View vista) {
        ...
        Intent i = new Intent(Bloque28.this, InfoClase.class);
        startActivity(i);
    }
    ...
    public void ejecutar_mapa(View vista){
        ...
        Intent inten = new Intent(Bloque28.this, Bloque28Maps.class);
        startActivity(inten);
    }
