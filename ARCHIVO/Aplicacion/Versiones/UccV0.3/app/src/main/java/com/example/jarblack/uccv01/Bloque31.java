...
public class Bloque31 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bloque31);
    ...
    public void ejecutar_info(View vista) {
        ...
        Intent i = new Intent(Bloque31.this, InfoClase.class);
        startActivity(i);
    }

    public void ejecutar_mapa(View vista){
        Intent inten = new Intent(Bloque31.this, Bloque31Maps.class);
        startActivity(inten);
    }
